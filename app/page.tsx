...
`,
      ...
      <div id="triptych" aria-label="Who is OutsYde for">
        <div className="tri-panel panel-biz">
          <div className="tri-bg" style={{ backgroundImage: "url('/panel-01-business.jpg')" }} aria-hidden="true" />
        ...
        <div className="tri-panel panel-photo">
          <div className="tri-bg" style={{ backgroundImage: "url('/panel-03-photographer.jpg')" }} aria-hidden="true" />
          <div className="tri-overlay" aria-hidden="true" />
